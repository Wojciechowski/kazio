...
$config['SITE_PATH'] = dirname(dirname(dirname(__FILE__))) . DIRECTORY_SEPARATOR;// .'new' . DIRECTORY_SEPARATOR;
//$config['SITE_PATH'] = realpath('..').'/new/';
$config['PROTECTED_FOLDER'] = 'protected/';
$config['BASE_PATH'] =  DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'dooframework' . DIRECTORY_SEPARATOR;
...
////$config['TEMPLATE_ENGINE'] = 'Twig_Autoloader'; // Twig templates
