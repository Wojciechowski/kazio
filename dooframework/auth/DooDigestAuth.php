 ...
 * add the following line to your text.htaccess for digest auth to work correctly.</p>
...
class DooDigestAuth{
     ...
     * you have to tweak stuff in text.htaccess <code>RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization},L]</code></p>
     *
